...
{
    public partial class SalesReportForDelegateProductDetails : Form
    {
        ...
        MainForm MainForm;
        public SalesReportForDelegateProductDetails(MainForm MainForm)
        {
            try
            {
                InitializeComponent();
                ...
                if (load)
                {
                    ...
                    switch (comBox.Name)
                    {
                        ...
                        case "comBranch":
                            ...
                            string query1 = "select * from delegate where Branch_ID="+txtBranchID.Text;
                            MySqlDataAdapter da1 = new MySqlDataAdapter(query1, dbconnection);
                            DataTable dt1 = new DataTable();
                            da1.Fill(dt1);
                            comDelegate.DataSource = dt1;
                            comDelegate.DisplayMember = dt1.Columns["Delegate_Name"].ToString();
                            comDelegate.ValueMember = dt1.Columns["Delegate_ID"].ToString();
                            comDelegate.Text = "";
                            txtDelegateID.Text = "";
                            break;
                        case "comColor":
                    ...
                    if (txtBox.Text != "")
                    {
                        ...
                        switch (txtBox.Name)
                        {
                            ...
                            case "txtSort":
                                ...
                                break;
                            case "txtBranchID":
                                query = "select Sort_Value from sort where Sort_ID='" + txtBranchID.Text + "'";
                                com = new MySqlCommand(query, dbconnection);
                                if (com.ExecuteScalar() != null)
                                {
                                    Name = (string)com.ExecuteScalar();
                            ...
                            case "txtDelegateID":
                                ...
                                query = "select Delegate_Name from delegate where Delegate_ID='" + txtDelegateID.Text + "'";
                                com = new MySqlCommand(query, dbconnection);
                                if (com.ExecuteScalar() != null)
                                {
                                    Name = (string)com.ExecuteScalar();
