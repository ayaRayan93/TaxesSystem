...
namespace MainSystem
{
    public partial class StorageTaswayaAdding : Form
    {
        ...
        int Data_ID;
        string code = "";
        public StorageTaswayaAdding(Storage storage, XtraTabControl xtraTabControlStoresContent)
        {
            try
            {
                InitializeComponent();
        ...
        public void add2Store()
        {
            if (comStorePlace.Text != "" && code.Length==20)
            {
                ...
                {
                    query = "insert into addstorage (Store_ID,Date,Data_ID,Store_Place_ID,CurrentQuantity,AddingQuantity,QuantityAfterAdding,Note) values (@Store_ID,@Type,@Date,@Data_ID,@Store_Place_ID,CurrentQuantity,AddingQuantity,QuantityAfterAdding,@Note)";
                    com = new MySqlCommand(query, dbconnection);
                    ...
                    query = " update storage set Total_Meters="+ Convert.ToDouble(txtTotalMeter.Text) + Convert.ToDouble(txtAddingQuantity.Text) + " Data_ID= "+ Data_ID +" and Store_ID ="+ comStore.SelectedValue + " and Store_Place_ID = "+ comStorePlace.SelectedValue;
                    com = new MySqlCommand(query, dbconnection);
                    com.ExecuteNonQuery();
