...
{
    public class DataHelperClassUpdate
    {
        private DataSet _DataSet;
        private string _DataMember = "FirstTable";

        public DataHelperClassUpdate(DSparametrUpdate param)
        {
            switch (param)
            {
                case DSparametrUpdate.simpleDS:
                    {
                        MakeFirstTable();
                        break;
                    }
                case DSparametrUpdate.doubleDS:
                    {
                        MakeSecondTable();
                        break;
                    }
                case DSparametrUpdate.relatedDS:
                    {
                        MakeFirstTable();
                        MakeSecondTable();
                        MakeDataRelation();
        ...
        private void MakeFirstTable()
        {
            ...
            column.ColumnName = "ImportStorageReturnDetails_ID";
            column.AutoIncrement = false;
            column.Caption = "ImportStorageReturnDetails_ID";
