    ...
    public partial class CustomerDeliveryReport : Form
    {
        ...
        public void displayProducts()
        {
            try
            {
                ...
                string query = "SELECT Customer_Permissin_ID, customer_permissions.Customer_Permissin_ID as 'رقم الأذن', Store_Name as 'المخزن',taswayaa_adding_permision.Date as 'التاريخ',Note as 'الملاحظة' FROM taswayaa_adding_permision INNER JOIN store ON store.Store_ID = taswayaa_adding_permision.Store_ID   WHERE " + subQuery;
