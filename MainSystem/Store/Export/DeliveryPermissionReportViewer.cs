...
namespace MainSystem.Store.Export
{
    public partial class DeliveryPermissionReportViewer : Form
    {
        ...
        string BranchBillNumber="", PerNum = "" , customerName="", clientName="", customerPhone="", delegateName="", date="", branchId="", branchName="", storeKeeper="", customerdelivery="", store_Name="",customerAddress="", customerdeliveryPhone="";
        bool flag = false;
