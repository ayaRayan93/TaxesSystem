...
namespace MainSystem
{
    public partial class Factory_Transitions_Report : Form
    {
        ...
        public Factory_Transitions_Report()
        {
            InitializeComponent();
