                        ...
                        switch (txtBox.Name)
                        {
                            ...
                            case "txtCodeSearch4":
                                ...
                                if (com.ExecuteScalar() != null)
                                {
                                    ...
                                    dbconnection.Close();
                                    dbconnection.Open();
                                    //date(storage.Storage_Date) between '2020-01-03' and '" + dateTimePicker2.Value.ToString("yyyy-MM-dd") + "' and
