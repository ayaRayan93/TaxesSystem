            ...
            try
            {
                if (gridView1.SelectedRowsCount > 0)
                {
                    ...
                    for (int i = 0; i < gridView1.SelectedRowsCount; i++)
                    {
                        ...
                        string query = "update transfer_product set Confirm_From=1,Confirm_From_Date=@Date where TransferProduct_ID=" + row2[0].ToString();
