...
namespace MainSystem
{
    public partial class DesignPrint : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void InitData(DateTime dateNow, int customerDesignID, string transitionID, string branchName, string clientName, double paidMoney, string paymentMethod, string bank, string checkNumber, string payday, string operationNumber, string description, string bankUserName, string engDesign, string DelegateName, int qq200, int qq100, int qq50, int qq20, int qq10, int qq5, int qq1, int qqH, int qqQ, int rr200, int rr100, int rr50, int rr20, int rr10, int rr5, int rr1, int rrH, int rrQ)
        {
