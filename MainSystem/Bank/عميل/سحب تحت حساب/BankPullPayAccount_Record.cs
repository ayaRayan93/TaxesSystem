...
{
    public partial class BankPullPayAccount_Record : Form
    {
        ...
        public static bool addBankPullPayAccountTextChangedFlag = false;
        XtraTabPage xtraTabPage;

        public BankPullPayAccount_Record()
        {
            InitializeComponent();
        ...
        private void BankPullPayAccount_Record_Load(object sender, EventArgs e)
        {
            try
            {
                if (!loadedBranch)
            ...
            try
            {
                ...
                if (check)
                {
                    ...
                    if (double.TryParse(txtPullMoney.Text, out outParse))
                    {
                        ...
                        addBankPullPayAccountTextChangedFlag = false;
        ...
        private void txtBox_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (loadedBranch)
                {
                    xtraTabPage = getTabPage("tabPageRecordPullPayAccount");
                    if (!IsClear())
                    {
                        xtraTabPage.ImageOptions.Image = Properties.Resources.unsave;
                        addBankPullPayAccountTextChangedFlag = true;
                    }
                    else
                    {
                        xtraTabPage.ImageOptions.Image = null;
