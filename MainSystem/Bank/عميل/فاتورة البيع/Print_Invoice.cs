...
namespace TaxesSystem
{
    public partial class Print_Invoice : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void InitData(string client_Name, string customerName, string phoneNumber, string delegate_Name, DateTime billDate, string pay_Type, int bill_Number, string branchId, string branch_Name, double TotalBillPriceBD, double TotalBillPriceAD, double TotalDiscount, List<Bill_Items> Bill_Items)
        {
