...
{
    public partial class BankDepositPayAccount_Record : Form
    {
        MySqlConnection dbconnection;
        string ClientType = "عميل";
        int ClintID = 0;
        int PayAccountID = 0;
        ...
        public static bool addBankDepositPayAccountTextChangedFlag = false;
        XtraTabPage xtraTabPage;

        public BankDepositPayAccount_Record()
        {
            InitializeComponent();
        ...
        private void BankDepositPayAccount_Record_Load(object sender, EventArgs e)
        {
            try
            {
                if (!loadedBranch)
            ...
            try
            {
                ...
                if (check)
                {
                    ...
                    if (double.TryParse(txtPaidMoney.Text, out outParse))
                    {
                        ...
                        string query = "insert into transitions (Branch_ID,Branch_Name,Client_Name,Client_ID,Transition,Payment_Method,Bank_ID,Bank_Name,Date,Amount,Data,PayDay,Check_Number,Operation_Number,Bill_Number,Type,Error) values(@Branch_ID,@Branch_Name,@Client_Name,@Client_ID,@Transition,@Payment_Method,@Bank_ID,@Bank_Name,@Date,@Amount,@Data,@PayDay,@Check_Number,@Operation_Number,@Bill_Number,@Type,@Error)";
                        MySqlCommand com = new MySqlCommand(query, dbconnection);

                        com.Parameters.Add("@Transition", MySqlDbType.VarChar, 255).Value = "ايداع";
                        com.Parameters.Add("@Type", MySqlDbType.VarChar, 255).Value = "تحت حساب";
                        ...
                        com.Parameters.Add("@Bill_Number", MySqlDbType.Int16, 11).Value = PayAccountID;
                        ...
                        com.Parameters.Add("@Client_Name", MySqlDbType.VarChar, 255).Value = txtName.Text;
                        com.Parameters.Add("@Client_ID", MySqlDbType.Int16, 11).Value = ClintID;
                        ...
                        addBankDepositPayAccountTextChangedFlag = false;
        ...
        private void txtBox_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (loadedBranch)
                {
                    xtraTabPage = getTabPage("tabPageRecordDepositPayAccount");
                    if (!IsClear())
                    {
                        xtraTabPage.ImageOptions.Image = Properties.Resources.unsave;
                        addBankDepositPayAccountTextChangedFlag = true;
                    }
                    else
                    {
                        xtraTabPage.ImageOptions.Image = null;
        ...
        private void RecordPayAccount()
        {
            ...
            {
                query = "insert into customer (Customer_Name,Customer_Phone,Customer_Start,Customer_Type) values(@Customer_Name,@Customer_Phone,@Customer_Start,@Customer_Type)";
                com = new MySqlCommand(query, dbconnection);
                com.Parameters.Add("@Customer_Name", MySqlDbType.VarChar, 255).Value = txtName.Text;
                ...
                com.Parameters.Add("@Customer_Type", MySqlDbType.VarChar, 255).Value = ClientType;
                com.ExecuteNonQuery();
            ...
            com = new MySqlCommand(query, dbconnection);
            com.Parameters.Add("@Money", MySqlDbType.Decimal, 10).Value = txtPaidMoney.Text;
            com.Parameters.Add("@Client_ID", MySqlDbType.Int16, 11).Value = ClintID;
            com.Parameters.Add("@Client_Name", MySqlDbType.VarChar, 255).Value = txtName.Text;
            com.Parameters.Add("@Employee", MySqlDbType.VarChar, 255).Value = txtEmployee.Text;
            com.Parameters.Add("@Taswya", MySqlDbType.VarChar, 255).Value = "لا";
            com.ExecuteNonQuery();
