    ...
    public partial class UpdateSellPrice : Form
    {
        ...
        public void setData(DataRowView row1)
        {
           // txtCode.Text = row1["الكود"].ToString();
            ...
            txtPercentageDelegate.Text = row1["نسية المندوب"].ToString();
