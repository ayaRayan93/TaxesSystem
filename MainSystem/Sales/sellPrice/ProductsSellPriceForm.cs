        ...
        private void gridView1_RowStyle(object sender, RowStyleEventArgs e)
        {
            try
            {
                ...
                if (e.RowHandle >= 0)
                {
                    ...
                    int offerFlag = Convert.ToInt16(View.GetRowCellDisplayText(e.RowHandle, View.Columns["OfferFlag"]));
                    if (offerFlag==1)
                    {
