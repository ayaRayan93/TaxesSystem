...
namespace MainSystem
{
    public partial class Print_CopyReturnedInvoice : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void InitData(string client_Name, DateTime billDate, string pay_Type, int bill_Number, string branchId, string branch_Name, double TotalBillPriceAD, string returnInfo, List<CopyReturnedBill_Items> Bill_Items)
        {
