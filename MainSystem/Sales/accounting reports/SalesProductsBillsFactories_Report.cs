...
{
    public partial class SalesProductsBillsFactories_Report : Form
    {
        ...
        public SalesProductsBillsFactories_Report(MainForm BankMainForm)
        {
            InitializeComponent();
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                if (comFactory.Text != "" && txtFactory.Text != "")
                {
                    search();
                }
                else
        ...
        private void btnBillReport_Click(object sender, EventArgs e)
        {
            try
            {
                if (comFactory.Text != "" && txtFactory.Text != "" && gridView1.RowCount > 0)
                {
                    ...
                    Report_Items_BillsFactories f = new Report_Items_BillsFactories();
                    f.PrintInvoice(comFactory.Text, dateTimePicker1.Value.Date, dateTimePicker2.Value.Date, bi);
                    f.ShowDialog();
                }
                else
                {
