...
{
    public partial class DashRequest_Report : Form
    {
        ...
        public DashRequest_Report(MainForm mainform, XtraTabControl tabControl)
        {
            InitializeComponent();
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                mainForm.bindRecordDashRequestForm(this, row1);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
