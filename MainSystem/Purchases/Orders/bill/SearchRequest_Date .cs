    ...
    public partial class SearchRequest_Date : Form
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    query = "select Branch_Name as 'الفرع',BranchBillNumber as 'رقم الفاتورة',Employee_Name as 'الموظف المسئول',Supplier_Name as 'المورد',Store_Name as 'المخزن',Request_Date as 'تاريخ الطلب',Receive_Date as'تاريخ الاستلام' from orders where orders.Branch_ID=" + branchID + " and Request_Date >='" + d + "' and Request_Date <='" + d2 + "'";
                    
                }
                else
                {
                    query = "select Branch_Name as 'الفرع', BranchBillNumber as 'رقم الفاتورة',Employee_Name as 'الموظف المسئول',Supplier_Name as 'المورد',Store_Name as 'المخزن',Request_Date as 'تاريخ الطلب',Receive_Date as'تاريخ الاستلام' from orders where Request_Date >='" + d + "' and Request_Date <='" + d2 + "'";
