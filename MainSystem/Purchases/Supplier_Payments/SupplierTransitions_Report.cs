...
namespace MainSystem
{
    public partial class SupplierTransitions_Report : Form
    {
        ...
        public void search(int supplierId)
        {
            ...
            MySqlDataAdapter adapter = new MySqlDataAdapter("SELECT supplier_transitions.SupplierTransition_ID as 'التسلسل',supplier_transitions.Transition as 'النوع',supplier.Supplier_Name as 'المورد',supplier_transitions.Payment_Method as 'طريقة الدفع',supplier_transitions.Bank_Name as 'الخزينة/البنك',supplier_transitions.Date as 'التاريخ',supplier_transitions.Amount as 'المبلغ',supplier_transitions.Data as 'البيان',supplier_transitions.Payday as 'تاريخ الاستحقاق',supplier_transitions.Check_Number as 'رقم الشيك',supplier_transitions.Operation_Number as 'رقم العملية' FROM supplier_transitions INNER JOIN supplier ON supplier.Supplier_ID = supplier_transitions.Supplier_ID where supplier_transitions.Paid='تم' and supplier_transitions.Error=0 and supplier_transitions.SupplierTransition_ID=0", dbconnection);
            ...
            if (supplierId == 0)
            {
                string query = "SELECT supplier_transitions.SupplierTransition_ID as 'التسلسل',supplier_transitions.Transition as 'النوع',supplier.Supplier_Name as 'المورد',supplier_transitions.Payment_Method as 'طريقة الدفع',supplier_transitions.Bank_Name as 'الخزينة/البنك',supplier_transitions.Date as 'التاريخ',supplier_transitions.Amount as 'المبلغ',supplier_transitions.Data as 'البيان',supplier_transitions.Payday as 'تاريخ الاستحقاق',supplier_transitions.Check_Number as 'رقم الشيك',supplier_transitions.Operation_Number as 'رقم العملية' FROM supplier_transitions INNER JOIN supplier ON supplier.Supplier_ID = supplier_transitions.Supplier_ID where supplier_transitions.Paid='تم' and supplier_transitions.Error=0";
            ...
            {
                string query = "SELECT supplier_transitions.SupplierTransition_ID as 'التسلسل',supplier_transitions.Transition as 'النوع',supplier.Supplier_Name as 'المورد',supplier_transitions.Payment_Method as 'طريقة الدفع',supplier_transitions.Bank_Name as 'الخزينة/البنك',supplier_transitions.Date as 'التاريخ',supplier_transitions.Amount as 'المبلغ',supplier_transitions.Data as 'البيان',supplier_transitions.Payday as 'تاريخ الاستحقاق',supplier_transitions.Check_Number as 'رقم الشيك',supplier_transitions.Operation_Number as 'رقم العملية' FROM supplier_transitions INNER JOIN supplier ON supplier.Supplier_ID = supplier_transitions.Supplier_ID where supplier_transitions.Paid='تم' and supplier_transitions.Error=0 and supplier_transitions.Supplier_ID=" + supplierId;
                MySqlCommand comand = new MySqlCommand(query, dbconnection);
                MySqlDataReader dr = comand.ExecuteReader();
                while (dr.Read())
                {
