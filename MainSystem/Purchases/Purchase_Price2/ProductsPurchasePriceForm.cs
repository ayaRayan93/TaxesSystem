...
{
    public partial class ProductsPurchasePriceForm : Form
    {
        ...
        public ProductsPurchasePriceForm(MainForm purchasesMainForm)
        {
            try
            {
                InitializeComponent();
        ...
        private void ProductsPurchasePriceForm_Load(object sender, EventArgs e)
        {
            try
            {
                dbconnection.Open();
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               List<DataRowView> recordList=new List<DataRowView>();
                ...
                {
                    purchasesMainForm.bindUpdatePurchasePriceForm(recordList, this, "");
                }
                else
                {
        ...
        private void btnReport_Click(object sender, EventArgs e)
        {
            try
            {
                purchasesMainForm.bindReportPurchasePriceForm(gridControl1);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                purchasesMainForm.bindRecordPurchasePriceForm(this);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
