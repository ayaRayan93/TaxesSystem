...
{
    public partial class PurchaseQuantityDetails_Report : Form
    {
        ...
        public PurchaseQuantityDetails_Report(MainForm BankMainForm, XtraTabControl xtraTabControlPurchases)
        {
            InitializeComponent();
            ...
            while (dataReader1.Read())
            {
                ...
                if (gridView1.IsNewItemRow(rowHandle))
                {
                    ...
                    if (com2.ExecuteScalar() != null)
                    {
                        ...
                        gridView1.SetRowCellValue(rowHandle, gridView1.Columns["الكمية المرتجعة"], ReturnedQuantity);
        ...
        private void btnBillReport_Click(object sender, EventArgs e)
        {
            try
            {
                if (comType.SelectedValue != null && comType.Text != "" && comFactory.Text != "" && comFactory.SelectedValue != null && gridView1.RowCount > 0)
                {
                    ...
                    f.PrintInvoiceQuantity(comStore.Text, dateTimePicker1.Value.Date, dateTimePicker2.Value.Date, bi);
                    f.ShowDialog();
                }
                else
                {
