...
{
    public partial class SafeExpenseIncome_Record : Form
    {
        ...
        public SafeExpenseIncome_Record(XtraTabControl MainTabControlExpense)
        {
            InitializeComponent();
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                if (comBank.Text != "" && txtPullMoney.Text != "" && txtDescrip.Text != "" && txtClient.Text != "")
                {
                    double outParse;
